...
import com.pantheon.backend.core.inventory.local.processor.LocalGamesProcessor;
...
public class InventoryLocalScanServiceTest {

    // TODO: fix tests for new ScannerUtil Logic

    private static final Logger log = LoggerFactory.getLogger(InventoryLocalScanServiceTest.class);
    ...
    void setUp() {
        ...
        inventoryLocalScanService = new InventoryLocalScanService(
    ...
    void testNoLocalLibraryClient() {
        ...
        assertThrows(IllegalStateException.class, () -> inventoryLocalScanService.scanPlatformPaths(platformMock));
